...
# kedro_docker_experiment documentation build
...
from kedro_docker_experiment import __version__ as release

# -- Project information -----------------------------------------------------

project = "kedro_docker_experiment"
copyright = "2020, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
htmlhelp_basename = "kedro_docker_experimentdoc"
...
latex_documents = [
    (
        master_doc,
        "kedro_docker_experiment.tex",
        "kedro_docker_experiment Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "kedro_docker_experiment",
        "Project kedro_docker_experiment codebase.",
        "Data-Science",
    )
]
